 ...
 */
import { runStructuredQuery } from "../../src/core/query/sync";
import { runStructuredQueryAsync } from "../../src/core/query/async";
...
// Run the performance test if this is the main module
if (import.meta.main) {
  runPerformanceTest();
}
